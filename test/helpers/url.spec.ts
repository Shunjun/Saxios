...
import isURLSameOrigin from '../../src/helper/isURLSameOrigin';
import isAbsoluteURL from '../../src/helper/isAbsoluteURL';
import buildFullUrl from '../../src/helper/buildFullUrl';
// import combineURLs from '../../src/helper/combineURLs';
...
describe('helpers:url', () => {
  ...
  describe('buildFullUrl', () => {
    test('should combine URL', () => {
      expect(buildFullUrl('https://api.github.com', '/users')).toBe('https://api.github.com/users');
    });

    test('should remove duplicate slashes', () => {
      expect(buildFullUrl('https://api.github.com/', '/users')).toBe(
